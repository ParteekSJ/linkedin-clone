  ...
  return (
    <div className="space-y-10 relative">
      ...
      <main className="flex flex-col xl:flex-row items-center max-w-screen-lg mx-auto">
        ...
        {/* DISPLAY IMAGE <xl:flex-row xl:flex-col */}
...
/**
 * When using layout:`fill` on an <Image> make sure to set the position of the parent element <div> to be `relative`, so it `FILLS` the parent <div>
 *  */
