...
export default function Widgets({ articles }) {
  return (
    <div className="hidden xl:inline space-y-2">
      {/* NEWS */}
      <div className="bg-white dark:bg-[#1D2226] py-2.5 space-y-2 rounded-lg w-11/12 overflow-hidden border border-gray-300 dark:border-none">
        {/* HEADING */}
      ...
      {/* ADS */}
      <div className="bg-white dark:bg-[#1D2226] w-11/12 h-64 px-0.5 rounded-lg sticky top-20 border border-gray-300 dark:border-none">
